    ...
    <template #content>
      ...
      <div class="d-flex align-items-center mt-3">
        <JetButton @click="confirmLogout">
          <span v-if="form.recentlySuccessful">
            <i class="fas fa-check-circle text-success fa-fw"></i> Done.
          </span>
          <span v-else>
            <i class="fas fa-save fa-fw"></i> Log Out Other Browser Sessions
          </span>
        </JetButton>
      </div>
      ...
      <JetDialogModal :show="confirmingLogout" @close="closeModal">
        ...
        <template #footer>
          ...
          >
            <i class="fas fa-sign-out-alt fa-fw"></i> Log Out Other Browser
            Sessions
          </JetButton>
        </template>
      </JetDialogModal>
